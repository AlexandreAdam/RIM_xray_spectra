...
#SBATCH --job-name=Train_RIM_xray_with_prior
...
python $HOME/scratch/RIM_xray_spectra/scripts/train_rim.py \
    ...
    --logname_prefix=rim_xray_xlusters_light_with_prior\
    --snr_max=1000\
    --snr_min=5\
    --noise_distribution=log_uniform\
    --hyperparameters=$HOME/scratch/RIM_xray_spectra/scripts/rim_xray_light_hparams.json\
    --epochs=20000\
    --clip=1\
    --ema_decay=0.99\
    --batch_size=32\
